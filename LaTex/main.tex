...
\DeclareMathOperator*{\degcent}{degree}
\DeclareMathOperator*{\spl}{shortest\,path\,length}
\DeclareMathOperator*{\diam}{diameter}
\DeclareMathOperator*{\neigh}{neighborhood}
\DeclareMathOperator*{\walld}{wall\,distance}
\DeclareMathOperator*{\maxwalld}{maximum\,wall\,distance}
\DeclareMathOperator*{\cartd}{Cartesian\,distance}
...
% Set space after equation equal to the one before it.
\makeatletter
\g@addto@macro\normalsize{%
