...
In the fourth chapter we present a tool that uses Graph Theory to place game elements in procedurally generated levels, with an overview of the theory and the assumptions behind it.
