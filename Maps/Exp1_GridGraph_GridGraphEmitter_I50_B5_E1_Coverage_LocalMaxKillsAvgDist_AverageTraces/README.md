Here we optimized the coverage of the map while exploring the average distance between local maxima in Kills perfomed by the bots, and the average length of the kills traces, but using grid graph.
