...
from internals.constants import GENOME_NUM_COLUMNS, GENOME_NUM_ROWS
...
def crossover(ind1, ind2):
    ...
    mid_point_row = random.randint(0, GENOME_NUM_ROWS - 2)
    mid_point_column = random.randint(0, GENOME_NUM_COLUMNS - 2)
    ...
    if random.random() < 0.5:
        ...
        end_column = GENOME_NUM_COLUMNS - 1
