...
namespace Maps.MapGenerator
{
    ...
    {
        [Header("Digger generation")] [SerializeField] [Range(0, 100)]
        ...
        [Header("Stairs generation")] [SerializeField]
        ...
        public override char[,] GenerateMap()
        {
            ...
            if (useABGeneration) ParseGenome();
            if (tiles != null && tiles.Count > 0) stairProbability = 0;
            ...
            if (createTextFile && !useABGeneration) SaveMapAsText(textMap);
        ...
        private void DigMap()
        {
            ...
            var stopCount = width * height * roomPercentage / 100;
            ...
            {
                var nextAction = pseudoRandomGen.Next(0, 100);
        ...
        {
            var c = visitedTiles[pseudoRandomGen.Next(0, visitedTiles.Count - 1)];
            currentX = c.tileX;
            currentY = c.tileY;
        }
        ...
        {
            var totalSum = forwardProbability;
        ...
        {
            var genome = "<" + forwardProbability + "," + leftProbability + "," + rigthProbability + "," +
