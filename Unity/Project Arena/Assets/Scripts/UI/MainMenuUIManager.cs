...
namespace UI
{
    ...
    {
        [Header("Scenes")] [SerializeField] private Mode[] singleplayerModes;

        [SerializeField] private Mode[] multiplayerModes;
        ...
        [Header("Main menu fields")] [SerializeField]
        private Button quitButton;

        [SerializeField] private Button experimentButton;

        [Header("Singleplayer fields")] [SerializeField]
        ...
        [Header("Multiplayer fields")] [SerializeField]
        ...
        [Header("Loading fields")] [SerializeField]
        ...
        private bool currentIsMultilevel;
        ...
        private void Loading()
        {
            ...
            if (currentGeneration == 2)
            {
                ...
                var errorCode = currentIsMultilevel
        ...
        private void ActivateCurrentModeSP()
        {
            ...
            currentMap = 0;
            currentGeneration =
                GetMinGenerationIndex(singleplayerModes[currentMode].maps[currentMap].enabledGenerations);
        ...
        private void ActivateCurrentGenerationSP()
        {
            ...
            inputSP.interactable = singleplayerModes[currentMode].maps[currentMap].enabledGenerations[currentGeneration]
                .inputEnabled;
            inputSP.text = "";
            ...
            if (currentGeneration == 0)
                ...
                inputSP.placeholder.GetComponent<Text>().text = singleplayerModes[currentMode].maps[currentMap]
                    .enabledGenerations[currentGeneration].placeholder;
        }
        ...
        {
            currentGeneration = GetCiruclarIndex(currentGeneration,
                multiplayerModes[currentMode].maps[currentMap].enabledGenerations, false);
            ActivateCurrentGenerationMP();
        }
        ...
        private void ActivateCurrentModeMP()
        {
            ...
            currentMap = 0;
            currentGeneration =
                GetMinGenerationIndex(multiplayerModes[currentMode].maps[currentMap].enabledGenerations);
        ...
        private void ActivateCurrentGenerationMP()
        {
            ...
            if (currentGeneration == 0)
                ...
                inputMP.placeholder.GetComponent<Text>().text = singleplayerModes[currentMode].maps[currentMap]
                    .enabledGenerations[currentGeneration].placeholder;
        }
        ...
        private int GetCiruclarIndex(int current, Generation[] mask, bool next)
        {
            if (next)
            {
                for (var i = current; i < mask.Length; i++)
            ...
            else
            {
                for (var i = current; i >= 0; i--)
                    if (mask[i].enabled && i != current)
                        return i;
                for (var i = mask.Length - 1; i > current; i--)
                    if (mask[i].enabled && i != current)
                        return i;
            }
        ...
        {
            mapDNA = DateTime.Now.GetHashCode().ToString();
            return mapDNA;
        }
