...
namespace AI.BonsaiBehaviours.Actions
{
    ...
    /// </summary>
    [BonsaiNode("Tasks/")]
    public class UseEquippedGun : Task
    {
        ...
        public int lookAheadFrames = 3;
        public float lookAheadTimeStep = 0.3f;
        public string isGoingForCoverKey;

        private bool IsGoingForCover => Blackboard.Get<bool>(isGoingForCoverKey);
        ...
        public override Status Run()
        {
            ...
            if (lastSightedTime != Time.time && IsGoingForCover && !gunManager.IsCurrentGunReloading())
