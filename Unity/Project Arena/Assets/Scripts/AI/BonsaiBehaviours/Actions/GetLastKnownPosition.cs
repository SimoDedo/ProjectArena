...
namespace AI.BonsaiBehaviours.Actions
{
    ...
    /// </summary>
    [BonsaiNode("Tasks/")]
    public class GetLastKnownPosition : Task
    {
        public string lastKnownPositionPathKey;
        private NavMeshPath LastKnownPositionPath
        {
            set => Blackboard.Set(lastKnownPositionPathKey, value);
        }
        ...
        private Status EstimateEnemyPositionFromKnowledge()
        {
            ...
            {
                LastKnownPositionPath = pathToEstimatedPos;
        ...
        private Status EstimateEnemyPositionFromTriggeringEvent(float time)
        {
            ...
            var myPosition = Actor.transform.position;
