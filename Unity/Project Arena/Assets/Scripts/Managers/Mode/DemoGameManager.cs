...
{
    /// <summary>
    ///     DemoGameManager is an implementation of GameManager. It simply generates a new map every generationInterval
    ///     seconds.
    /// </summary>
    public class DemoGameManager : GameManager
    {
        [Header("Demo variables")] [SerializeField] [Range(0, 10)]
        protected float generationInterval;
