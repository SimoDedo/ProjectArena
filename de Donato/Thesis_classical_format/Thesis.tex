...
\begin{figure}[H]
    \centering
    \subfloat[Example of a simple SMT-Genome without added corridors]{\includegraphics[width=0.5\textwidth]{images/SMT_NotAdded.png}}
    \subfloat[Example of a simple SMT-Genome with added corridors]{\includegraphics[width=0.5\textwidth]{images/SMT_added.png}}
...
\begin{figure}
    \centering
    \subfloat{\includegraphics[width=0.5\textwidth]{images/SMT_Added.png}}
    \subfloat{\includegraphics[width=0.5\textwidth]{images/SMT_Added_2.png}}
...
\begin{figure}[H]
    ...
    \qquad
    \subfloat[The graph obtained from the rooms]{\includegraphics[height=0.4\textwidth]{images/graph_dist.png}}
